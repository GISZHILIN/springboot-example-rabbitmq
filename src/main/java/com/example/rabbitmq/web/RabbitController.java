...
import com.example.rabbitmq.entity.QueueConfig;
...
public class RabbitController {
    ...
    @PostMapping("deleteQueueByParam")
    public void deleteQueueByParam(@RequestBody QueueConfig config) {
        rabbitUtil.deleteQueue(config.getQueueName(), true, true);
    }
    ...
    @PostMapping("andExchangeBindingQueue")
    public void andExchangeBindingQueue(@RequestBody QueueConfig config) {
        rabbitUtil.andExchangeBindingQueue(config.getExchangeType(), config.getExchangeName(), config.getQueueName(), config.getRoutingKey(), false, null);
    }
